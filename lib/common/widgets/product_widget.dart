...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isRestaurant) {
      ...
      price = product!.price!;
      discountPrice = PriceConverter.convertWithDiscount(
        price,
        discount,
        discountType,
      )!;
                              ...
                              if (isRestaurant && restaurant!.ratingCount! > 0)
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      isRestaurant
                                          ? restaurant!.avgRating!
                                                .toStringAsFixed(1)
                                          : product!.avgRating!.toStringAsFixed(
                                              1,
                                            ),
                                      style: robotoMedium,
                                    ),
                                    ...
                                    Text(
                                      '(${isRestaurant
                                          ? restaurant!.ratingCount! > 25
                                                ? '25+'
                                                : restaurant!.ratingCount
                                          : product!.ratingCount! > 25
                                          ? '25+'
                                          : product!.ratingCount})',
                                      style: robotoRegular.copyWith(
                            ...
                            !isRestaurant
                                ? GetBuilder<CartController>(
                                    builder: (cartController) {
                                      ...
                                      int cartIndex = cartController
                                          .isExistInCart(product!.id, null);
